...
// 'people' represents each element in the 'peoples' array.
let peoples = ["asim", "alex", "john", "brad"];

for (let people of peoples) {
  console.log(people); // Output: asim, alex, john, brad
}

// Using `for...of` loop to iterate through each character of a string.
// 'char' represents each character in the string 'text'.
const text = "Hello";
